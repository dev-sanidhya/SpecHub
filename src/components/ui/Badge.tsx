...
export function Badge({ children, variant = "default", className }: BadgeProps) {
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 rounded-full px-3 py-1.5 text-[11px] font-semibold tracking-[0.08em] uppercase",
        {
          ...
          "bg-indigo-500/15 text-indigo-600 dark:text-indigo-300": variant === "purple",
